...
const baseUrl = "https://demo.react.email/preview/nike-receipt?view=source";
          ...
          <Row style={recomendations.container}>
            ...
            >
              ...
              <Text style={recomendations.text}>
                Womens Nike Dri-FIT Soccer Jersey
              </Text>
            </Column>
            <Column style={recomendations.product} align="center">
              ...
              <Text style={recomendations.text}>
                Mens Nike Dri-FIT Short-Sleeve Football Shirt
              </Text>
            </Column>
            <Column style={recomendations.product} align="center">
              <Img
              ...
              <Text style={recomendations.text}>Womens Soccer Jacket</Text>
            </Column>
            <Column
            ...
            >
              ...
              <Text style={recomendations.title}>FFF</Text>
              <Text style={recomendations.text}>
                Womens Nike Pre-Match Football Top
              </Text>
            </Column>
          </Row>
        </Section>
